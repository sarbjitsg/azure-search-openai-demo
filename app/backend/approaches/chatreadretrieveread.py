...
class ChatReadRetrieveReadApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """Assistant that helps an aerospace engineering company employees with their EASA aviation rule questions and questions about the Easy Access Rules for Large Aeroplanes book which is also known as the CS-25. 
